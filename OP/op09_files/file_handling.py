...
def generate_people_report(person_data_directory: str, report_filename: str):
    """
...
rep = generate_people_report('data', 'report.csv')
...
#     writer.writerows(report_data)
# print(rep)
# assert generate_people_report('data', 'report.csv') == report_data
